...
namespace Xamarin.Droid.CrossWalkLite.SpecificAbi.DemoApp
{
    [Activity(Label = "Xamarin.Droid.CrossWalkLite.SpecificAbi.DemoApp", MainLauncher = true, Icon = "@drawable/icon")]
